...
def run_training(total_timesteps=400000, model_path=None, buffer_path=None):
    ...
    if buffer_path is None:
        buffer_path = "sac_rov_phase6_replay_buffer.pkl"

    print("🧠 正在加载 Phase 6 模型，准备迎接洋流洗礼...")
    model = SAC.load(
        model_path,
        env=env,
    ...
    print(f"🔥 开启 Phase 6 深海避障训练 ({total_timesteps} 步)！")
    ...
    final_model_path = "sac_rov_edge8_phase6_ready"
    final_buffer_path = "sac_rov_phase6_replay_buffer"
    print("✅ Phase 6 训练完成，保存最新模型...")
